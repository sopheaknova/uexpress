<?php get_header();?>
    ...
    <?php endif ?>
        ...
        <img src="<?php echo O2_SCRIPTS; ?>/timthumb.php?src=<?php echo O2_IMG; ?>/geo-link-logo.gif&amp;h=64&amp;w=199&amp;zc=1" />
        </a>
        </div>
        <p><strong>Geolink</strong> is one of the leading Cambodian logistics and distribution companies, offering a wide range of customized transportation, and supply chain management services. Geolink's clients are both multinational and local companies</p>
        </div>
        <!-- Message option 03 End -->
        <div class="clear"></div>
