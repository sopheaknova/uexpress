...
<div class="wrap" id="of_container">
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    ...
    <img style="display:none" src="<?php echo get_stylesheet_directory_uri(); ?>/framework/admin/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
...
function of_style_only() {
	wp_enqueue_style('admin-style', OF_DIRECTORY.'/framework/admin/admin-style.css');
	wp_enqueue_style('color-picker', OF_DIRECTORY.'/framework/admin/css/colorpicker.css');
}	
...
function of_load_only() {
	...
	wp_register_script('jquery-input-mask', OF_DIRECTORY.'/framework/admin/js/jquery.maskedinput-1.2.2.js', array( 'jquery' ));
	wp_enqueue_script('jquery-input-mask');
	wp_enqueue_script('color-picker', OF_DIRECTORY.'/framework/admin/js/colorpicker.js', array('jquery'));
	wp_enqueue_script('ajaxupload', OF_DIRECTORY.'/framework/admin/js/ajaxupload.js', array('jquery'));
